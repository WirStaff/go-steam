...
namespace GoSteamLanguageGenerator
{
    public class GoGen
    {
        ...
        public void EmitClasses(Node root, StringBuilder sb)
        {
            ...
            sb.AppendLine("    \"github.com/WirStaff/go-steam/steamid\"");
            sb.AppendLine("    \"github.com/WirStaff/go-steam/rwu\"");
            sb.AppendLine("    \"github.com/WirStaff/go-steam/protocol/protobuf\"");
            sb.AppendLine(")");
            sb.AppendLine();
